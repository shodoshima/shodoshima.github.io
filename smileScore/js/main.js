...
FACE.EXPRESSION = () => {
  ...
  checkFace = async () => {
    ...
    if(faceData.length){
      ...
      console.log('face no detect');
      emoticon.style.bottom = '0px';
      emoticon.style.backgroundColor = `rgb(100, 100, 100)`;
      emoticon.innerHTML = emoticonTxt[1];
      message.innerHTML = '顔検知なし';
    }
  };
